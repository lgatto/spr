...
\begin{frame}
  ...
  \item 2020-09-18: release 4.0.2.  Stable, multi-platform. Major release every April.
...
\begin{frame}
  ...
  \item Comprehensive \R Archive Network (CRAN) $\sim$ 16,332 packages
    [2020-09-18] (cf 1000 in April 2007).  XXX
...
\begin{frame}
  \frametitle{Case-study: HOTPO rule}
