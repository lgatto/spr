...
\begin{frame}
  ...
  \item 2014-10-07: release 3.1.1.
    Stable, multi-platform. Major release every March/April.
...
\begin{frame}
  ...
  \item Comprehensive \R Archive Network (CRAN) $\sim$ 5913 packages
    [2014-10-07] (cf 1000 in April 2007).
